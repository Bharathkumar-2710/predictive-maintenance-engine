"""
Database layer for the Predictive Maintenance System.
...
# Schema definitions (PostgreSQL-compatible DDL)
DDL_STATEMENTS = [
    """
...
class DatabaseManager:
    ...
    Thread-safe via per-call connection creation.
    """
    ...
    # Machines
    def upsert_machine(self, machine_id: str, max_cycle: int, degradation_rate: float) -> None:
        with self._conn() as conn:
            conn.execute("""
